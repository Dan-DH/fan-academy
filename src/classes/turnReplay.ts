...
//       currentGame: this.context.gameController!.game,
//       triggerReplay: false
//     } );
//   }
...
//     if (this.gameController.context.gameController!.activePlayer === this.context.userId) {
//       const opponentData = this.context.gameController!.isPlayerOne ? this.gameController.startTurnState.player2 : this.gameController.startTurnState.player1;
